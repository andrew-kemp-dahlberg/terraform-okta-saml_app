...
authentication_policy_rules = [
  {
    ...
    groups_included             = list(string) # Groups to include
    groups_excluded             = list(string) # Groups to exclude
    users_included              = list(string) # Users to include
    users_excluded              = list(string) # Users to exclude
